...
Source0  : https://files.pythonhosted.org/packages/d6/3b/2dc38264c9dfe0974f44ee075672cf6ed09fc8a3c4d8e409785ca35e935e/readme_renderer-25.0.tar.gz
...
%prep
%setup -q -n readme_renderer-25.0
cd %{_builddir}/readme_renderer-25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584306084
...
cp %{_builddir}/readme_renderer-25.0/LICENSE %{buildroot}/usr/share/package-licenses/readme_renderer/43a3a49bd7af636c923a5ae475395b8e29320529
