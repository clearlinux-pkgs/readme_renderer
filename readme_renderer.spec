...
%prep
%setup -q -n readme_renderer-29.0
cd %{_builddir}/readme_renderer-29.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614097690
...
cp %{_builddir}/readme_renderer-29.0/LICENSE %{buildroot}/usr/share/package-licenses/readme_renderer/43a3a49bd7af636c923a5ae475395b8e29320529
