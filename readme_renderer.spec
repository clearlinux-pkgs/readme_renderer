...
Source0  : https://files.pythonhosted.org/packages/13/d6/8e241e4e40404a1f83567d6a29798abee0b9b50b08c8efc815ce11c41df9/readme_renderer-26.0.tar.gz
...
%prep
%setup -q -n readme_renderer-26.0
cd %{_builddir}/readme_renderer-26.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588008399
...
cp %{_builddir}/readme_renderer-26.0/LICENSE %{buildroot}/usr/share/package-licenses/readme_renderer/43a3a49bd7af636c923a5ae475395b8e29320529
