...
Source0  : https://files.pythonhosted.org/packages/cb/a5/9d2333bd020bb1979ba51ab5acf59d77559951405e024e49576b5bee1a90/readme_renderer-30.0.tar.gz
...
%prep
%setup -q -n readme_renderer-30.0
cd %{_builddir}/readme_renderer-30.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633015239
...
cp %{_builddir}/readme_renderer-30.0/LICENSE %{buildroot}/usr/share/package-licenses/readme_renderer/43a3a49bd7af636c923a5ae475395b8e29320529
